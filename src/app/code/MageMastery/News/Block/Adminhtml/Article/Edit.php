...
namespace MageMastery\News\Block\Adminhtml\Article;
...
class Edit extends Container
{
    ...
    {
        if ($this->registry->registry('news_article')->getId()) {
            return __("Edit Article '%1'", $this->escapeHtml($this->registry->registry('news_article')->getTitle()));
        }
