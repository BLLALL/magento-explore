<?php
namespace MageMastery\Jobs\Block\Adminhtml\Job\Edit;
...
class Form extends Generic
{
     ...
     * @param \MageMastery\Jobs\Model\Source\Job\Status $status
     * @param \MageMastery\Jobs\Model\Source\Department $department
     * @param array $data
     */
    public function __construct(
        ...
        \MageMastery\Jobs\Model\Source\Job\Status $status,
        \MageMastery\Jobs\Model\Source\Job\Department $department,
        array $data = []
    ) {
    ...
    {
        /** @var \MageMastery\Jobs\Model\Job $model */
