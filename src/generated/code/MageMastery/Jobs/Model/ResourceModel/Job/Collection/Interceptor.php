<?php
namespace MageMastery\Jobs\Model\ResourceModel\Job\Collection;

/**
 * Interceptor class for @see \MageMastery\Jobs\Model\ResourceModel\Job\Collection
 */
class Interceptor extends \MageMastery\Jobs\Model\ResourceModel\Job\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addStatusFilter($job, $department)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStatusFilter', func_get_args(), $pluginInfo) : parent::addStatusFilter($job, $department);
    }
